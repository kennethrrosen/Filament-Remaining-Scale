/*	
Purpose Built Weigh-Scale-Project to continuously show a "Filament-Length-Remaining"
display for a 3D-Printer based on a design and guide by Edward Andrews.
original source: https://www.nutsvolts.com/magazine/article/build-a-3d-printer-filament-scale
...
extern void SaveAllToEEPROM(uint8_t SaveWithAsk=true);
const uint8_t GBL_AutoSaveFlag=false;	//Set true to force oper to confirm all EEPROM writes, false skip
...
int Fnum =0;
const uint8_t FnumMax=16;		//Defines the maximum number of Filaments supported in the Filament DataBase. Nano RAM might runout if too big
...
struct FILAMENT_DATABASE FilType_DEFAULT[FnumMax] = {
	...
	{"PETG",Default_Fil_Diam,1.27},	//02
	{"????",Default_Fil_Diam,0.0},	//03
	{"????",Default_Fil_Diam,0.0},	//04
	{"????",Default_Fil_Diam,0.0},	//05
	{"????",Default_Fil_Diam,0.0}	//06
	{"????",Default_Fil_Diam,0.0},	//07
	{"????",Default_Fil_Diam,0.0},	//08
	{"????",Default_Fil_Diam,0.0},	//09
	{"????",Default_Fil_Diam,0.0}	//10
	{"????",Default_Fil_Diam,0.0},	//11
